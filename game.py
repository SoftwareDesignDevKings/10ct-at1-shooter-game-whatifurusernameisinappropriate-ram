...
class Game:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self.game_over:
                    ...
                    if event.key == pygame.K_r:  # Add this block to handle restart during gameplay
                        self.reset_game()
    ...
    def draw(self):
        ...
        health_img = pygame.transform.scale(self.assets["health"][hp], (100, 20))  # Increase health bar size
